...
const dict = {
  ...
  insightsDuplicatesTitle: { ko: "이번 달 다시 채운 것", en: "Restocked more than once" },
  insightsDuplicatesEmpty: { ko: "같은 물건을 두 번 이상 채운 기록이 없습니다.", en: "No item was restocked more than once." },
  insightsRestockMeta: { ko: "{count}회 · {qty}개", en: "{count}× · qty {qty}" },
  ...
  insightsPurchasedTotal: { ko: "합계", en: "Total" },
  insightsPurchasedNoPrice: { ko: "가격 없음", en: "No price" },
  insightsLoadFailed: { ko: "회고를 불러오지 못했습니다.", en: "Couldn’t load insights." },
  insightsHint: {
    ko: "소비·재입고는 재고 이력 기준입니다. 구매일은 없으면 등록일을 씁니다.",
    en: "Consume/restock use stock history. Purchase date falls back to created date when unset.",
  },
